...
<body>
    ...
    <!-- Bouton flottant pour le QCM -->
    <div id="qcmToggle" class="chat-button" style="position: fixed; bottom: 20px; right: 20px; z-index: 1000; font-size: 24px; cursor: pointer;">
        💬
    </div>

    <!-- Bouton flottant pour le chatbot -->
    <button id="chatbotToggle" class="chat-button" aria-label="Discuter avec l'IA" style="
    position: fixed;
    bottom: 20px;
    right: 20px;
    z-index: 1000;
...
">
    ...
    z-index: 999;
">
        <iframe src="chatbot.php" style="width:100%; height:100%; border:none; border-radius:15px;"></iframe>

    </div>


    <div id="qcmResultWidget" style="margin-top:10px;"></div>
    </div>
